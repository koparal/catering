        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                while (true)
                {
                    ...
                    qty = randomQty;
                    //Console.WriteLine("Guest {0} Tray {1} Food {2} QTY {3}", customer_id, tray, food, qty);
